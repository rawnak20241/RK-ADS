...
function isEmail(abbama5520@gmail.com) {
...
$name     = $_POST['RK ADS SOLUTION'];
$email    = $_POST['abbama5520@gmail.com'];
$subject  = $_POST['subject'];
$website  = $_POST['www.rkadssolution.pro'];
